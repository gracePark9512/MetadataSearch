...
protocol MMCollection:CustomStringConvertible {
    ...
    ///
    /// Removes a specific instance of a metadata from a given file
    ///
    /// - Parameters:
    /// - metadata: The item to remove from the collection
...
///
/// Checks to see if the file type is consistant with the key constraints, will make protocol once import works.
